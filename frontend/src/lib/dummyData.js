...
// Timeline events for FuturisticTimeline
export const dummyTimelineEvents = [
  {
    date: "2025-04-25",
    title: "Neural Uplink Established",
    description: "Primary connection with MasterX Neural Core initialized.",
    location: "NeuroCore Alpha",
    status: "Stable",
  },
  {
    date: "2025-04-26",
    title: "Dopamine Surge Mapped",
    description: "Analyzed peak dopamine activity during task flow state.",
    location: "Cortex Engine",
    status: "Analyzed",
  },
  {
    date: "2025-04-27",
    title: "Cognitive Pattern Synced",
    description: "Optimized focus alignment across frontal cortex units.",
    location: "MindPulse Node",
    status: "Synced",
  },
  {
    date: "2025-04-28",
    title: "Neural Grid Expanded",
    description: "Expanded neural pathways to accommodate higher processing.",
    location: "Grid Matrix",
    status: "Extended",
  },
  {
    date: "2025-04-29",
    title: "Goal Vector Achieved",
    description: "Successfully reached the day’s cognitive target efficiency.",
    location: "Mission Controller",
    status: "Complete",
  },
];
