...
{/* 
        ...
        <h1 className="neon-text text-3xl font-bold">Neon Glass Card</h1>
            <p>This should have a glowing effect with glass background.</p>
          </div>
    
          <button className="button-futuristic">Futuristic Button</button>
        ...
        <motion.section 
            ...
            <motion.div
                className="glass p-6 col-span-3 space-y-6"
                variants={{
                  hidden: { opacity: 0, y: 30, scale: 0.95 },
                  show: { opacity: 1, y: 0, scale: 1, transition: { duration: 0.8 } },
                }}
              ...
              >
                 ...
                 {/* NeuroStatChart */}
              <div>
                <h3 className="text-cyan-400 text-sm font-semibold mb-2 tracking-wide uppercase">
                  Neurostat Chart
                </h3>
